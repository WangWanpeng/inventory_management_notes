...
\item Wat triggert een bestelling, voorraadpositie of voorraadlevel. Studenten snappen het verschil niet. Stel daarom ergens deze vraag: Do we charge for $\IP$ or for $\IL$? So, which of the two should appear in the cost functions?
\item In cycle service level, moeten we nemen $\P{I_i > 0}$ of $P(I_i\geq 0}$?
\item Wat staat er in other-policies.tex?
\end{itemize}
